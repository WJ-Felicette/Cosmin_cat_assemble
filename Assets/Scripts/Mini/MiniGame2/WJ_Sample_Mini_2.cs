...
public class WJ_Sample_Mini_2 : MonoBehaviour
{
    ...
    ///////////////
    [SerializeField] MiniGame2Director MiniGame2Director;
    ...
    protected void MakeQuestion(string _qstCn, string _qstCransr, string _qstWransr, string _qstCd)
    {
        ...
        this.MiniGame2Director.nextText = _str;
        ...
        for (int i = 0, q = 0; i < nAnsrCount; ++i, ++q)
        {
            if (i == nAnsridx)
            {
                ...
                MiniGame2Director.answerId = i;
                //Debug.Log(btAnsr[i]);
                MiniGame2Director.ATextNextTextArr[i] = strAnswer;
                txAnsr[i] = strAnswer;
            ...
            else
            {
                ...
                MiniGame2Director.ATextNextTextArr[i] = tmWrAnswer[q];
