...
public class ButtonHandler : MonoBehaviour
{
    ...
    {
        Button[0].transform.DOMove(new Vector3(0, 150, 0), 1f).SetRelative();
        Button[1].transform.DOMove(new Vector3(0, 150, 0), 1f).SetRelative();
        Button[2].transform.DOMove(new Vector3(0, 275, 0), 1f).SetRelative();
    }
