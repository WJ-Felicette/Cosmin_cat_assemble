...
public class SceneManager : MonoBehaviour
{
    ...
    (int, string)[,] GoalStandard =  { { (1000, "초보 집사"), (2000, "중급 집사"), (3000, "스페셜리스트") },
                                    { (1000, "쉽지 않은 수학자의 길"), (2000, "어엿한 수학자"), (3000, "수학 역사의 한 페이지") },
                                    { (1000, "쥐들을 혼내주자"), (2000, "톰과 제리?"), (3000, "전설적인 존재") },
                                    { (1000, "금강산도 식후경"), (2000, "통조림 부자"), (3000, "뚱냥이") },
                                    { (1000, "미니게임 입문자"), (2000, "미니게임의 달인"), (3000, "골목길 오락대장") }};
